  ...
  return (
    ...
    >
      ...
      {selected !== null && (
        ...
        >
          {selected === element && (
            <div className="absolute bottom-[calc(100%_+_0.5rem)] left-1/2 transform -translate-x-1/2 z-50">
              <motion.div
                transition={springTransition}
                layoutId="selected"
...
const FooterFlow: React.FC<FooterFlowProps> = ({
  emblem,
  links = [],
  extraIcons = [],
  styleName = "",
  ...
  const footerMotion = useAnimation();
  ...
  useEffect(() => {
    ...
    runSequence();
  }, [footerMotion, emblemMotion, switchMotion, svgMotion, mobileView, isMounted]);
  ...
  return (
    <div className={`w-full bg-gray-50 dark:bg-black border-t border-gray-200 dark:border-gray-800 ${styleName}`}>
      <div className="hidden md:block">
        <div className="relative w-full max-w-7xl mx-auto h-24 flex items-center justify-between px-4 lg:px-10">
          <motion.div
            ...
            className="bg-gray-200/80 dark:bg-black/95 backdrop-blur-sm text-gray-800 dark:text-gray-200 px-4 lg:px-8 py-3 lg:py-4 rounded-full font-semibold text-lg lg:text-xl z-10 flex-shrink-0 flex items-center gap-2"
          >
            {emblem}
          ...
          >
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center justify-center w-10 h-10 bg-[#BB86FC] hover:bg-[#967BB6] text-white rounded-full transition-colors duration-200"
              title="Return to Top"
            >
          ...
          {/* Original Navbar SVG Connections */}
          <motion.svg
            initial={{ opacity: 0 }}
            animate={svgMotion}
      ...
      <div className="block md:hidden">
        <div className="w-full border-b border-gray-200/40 dark:border-gray-800/40 bg-gray-50/95 dark:bg-black/95 backdrop-blur supports-[backdrop-filter]:bg-gray-50/60 dark:supports-[backdrop-filter]:bg-black/60 relative">
          <div className="container flex h-16 max-w-screen-2xl items-center px-4">
            ...
            <div className="flex flex-1 items-center justify-end space-x-2">
              ...
              >
                ...
                <button
                  onClick={scrollToTop}
                  className="flex items-center justify-center w-8 h-8 bg-[#BB86FC] hover:bg-[#967BB6] text-white rounded-full transition-colors duration-200"
                  title="Return to Top"
                >
